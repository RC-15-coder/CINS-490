"""
Django settings for diabetes_predictor_website project.
...
SECRET_KEY = 'django-insecure-tk5kv-e&_rd@u#xt&cmou5a6tjr91-0bc*f_60m(jav!-ee==_'
...
WSGI_APPLICATION = 'diabetes_predictor_website.wsgi.application'
